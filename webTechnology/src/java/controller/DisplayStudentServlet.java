...
public class DisplayStudentServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        out.println("<a href=\"semester.html\" class=\"btn btn-primary\">Add Semester</a>");
...
//        
        ...
        if (students != null) {
            for (Student student : students) {
                ...
                out.println("<td><a href='editStudent?id=" + student.getId() + "' class='btn btn-primary'>Edit</a></td>");
